...
> มีเวอร์ชันที่ขับเคลื่อนด้วย **Jenkins** เป็น repo คู่กัน:
> [**cicd-gitops-jenkins-101**](https://github.com/PonPond/cicd-gitops-jenkins-101)
> — pipeline เดียวกัน ต่างกันที่ตัวสั่งงาน CI
